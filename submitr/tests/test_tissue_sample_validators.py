...
from .datafixtures import (
    ...
    # BWH_TISSUE_SAMPLE_SUBMITTED_ID,
    ...
    # sample_tissue_item,
    # sample_tissue_sample_tpc,
    # sample_tissue_sample_gcc,
    # mock_samples_cache,
    # mock_tissue_cache,
    # Helper functions
...
# # ============================================================================
# # Test _tissue_sample_external_id_validator() (Existing Validator)
# # ============================================================================
...
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,
#         TISSUE_SAMPLE_EXTERNAL_ID,
#         []  # empty sample_sources
#     )
#     del tissue_sample["sample_sources"]  # Remove entirely

#     mock_data = make_structured_data_mock({
#         "TissueSample": [tissue_sample],
#         "Tissue": []
#     })
...
# def test_external_id_validator_mismatch_tpc_tissue_sample():
#     """Error when TPC TissueSample external_id doesn't match Tissue."""
#     tissue = make_tissue(NDRI_TISSUE_SUBMITTED_ID, "SMHT999-3A")  # Different tissue
#     tissue_sample = make_tissue_sample(
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,
#         "SMHT001-3A-001",  # Doesn't match tissue
#         [NDRI_TISSUE_SUBMITTED_ID],
#         submission_centers=[NDRI_TPC_CENTER]
#     )
...
#     tissue = make_tissue(NDRI_TISSUE_SUBMITTED_ID, "SMHT999-3A")
#     tissue_sample = make_tissue_sample(
#         GCC_TISSUE_SAMPLE_SUBMITTED_ID,  # Non-TPC sample
#         "SMHT001-3A-001",
#         [NDRI_TISSUE_SUBMITTED_ID],  # Linking to TPC tissue
#         submission_centers=[GCC_CENTER]
#     )
...
#     tissue_sample = make_tissue_sample(
#         GCC_TISSUE_SAMPLE_SUBMITTED_ID,
#         "SMHT001-3A-001",  # Mismatched but neither is TPC
#         [GCC_TISSUE_SUBMITTED_ID],
#         submission_centers=[GCC_CENTER]
#     )
...
#     # Should not error since tissue not found in submission
#     mock_data.note_validation_error.assert_not_called()
...
# # ============================================================================
# # Test _tissue_sample_metadata_validator() (Main New Validator)
# # ============================================================================
...
# #@mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# @mock.patch('submitr.validators.utils.portal.search_tissue_samples_by_external_id')
# def test_metadata_validator_tpc_new_submission(mock_fetch):
#     """Allows new TPC sample."""
#     mock_fetch.return_value = []  # No existing samples
...
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_tpc_update_same_item(mock_fetch):
#     """Allows TPC to update own sample."""
#     existing_tpc = [make_tissue_sample(
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,
#         PRODUCTION_EXTERNAL_ID,
...
#         submission_centers=[NDRI_TPC_CENTER]
#     )]
#     mock_fetch.return_value = existing_tpc

#     # Same submitted_id - this is an update
#     tissue_sample = make_tissue_sample(
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,
#         PRODUCTION_EXTERNAL_ID,
#         [NDRI_TISSUE_SUBMITTED_ID],
...
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_tpc_duplicate(mock_fetch):
#     """Rejects duplicate TPC submission."""
#     existing_tpc = [make_tissue_sample(
#         "NDRI_OTHER_SAMPLE",  # Different submitted_id
#         PRODUCTION_EXTERNAL_ID,
#         [NDRI_TISSUE_SUBMITTED_ID],
#         submission_centers=[NDRI_TPC_CENTER]
#     )]
...
# @mock.patch('submitr.validators.tissue_sample_validator._get_tissue_submitted_id')
# @mock.patch('submitr.validators.tissue_sample_validator.item_utils.get_submitted_id')
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_gcc_new_with_tpc_baseline(mock_fetch, mock_get_submitted_id, mock_get_tissue_id):
#     """Allows new GCC when TPC exists with matching metadata."""
#     tpc_sample = make_tissue_sample(
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,
#         PRODUCTION_EXTERNAL_ID,
...
#         submission_centers=[NDRI_TPC_CENTER]
#     )
#     mock_fetch.return_value = [tpc_sample]
#     mock_get_submitted_id.return_value = NDRI_TISSUE_SAMPLE_SUBMITTED_ID
#     mock_get_tissue_id.return_value = GCC_TISSUE_SUBMITTED_ID
...
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_gcc_update_same_item(mock_fetch):
#     """Allows GCC to update own sample."""
#     tpc_sample = make_tissue_sample(
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,
#         PRODUCTION_EXTERNAL_ID,
...
#         submission_centers=[GCC_CENTER]
#     )
#     mock_fetch.return_value = [tpc_sample, existing_gcc]
...
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_gcc_no_tpc_baseline(mock_fetch):
#     """Rejects GCC without TPC baseline."""
#     mock_fetch.return_value = []  # No TPC sample
...
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_gcc_duplicate(mock_fetch):
#     """Rejects duplicate GCC submission."""
#     tpc_sample = make_tissue_sample(
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,
#         PRODUCTION_EXTERNAL_ID,
...
#     )
#     existing_gcc = make_tissue_sample(
#         "DAC_OTHER_SAMPLE",  # Different submitted_id
#         PRODUCTION_EXTERNAL_ID,
#         [GCC_TISSUE_SUBMITTED_ID],
#         submission_centers=[GCC_CENTER]
#     )
...
# @mock.patch('submitr.validators.tissue_sample_validator.item_utils.get_submitted_id')
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_gcc_metadata_mismatch(mock_fetch, mock_get_submitted_id, mock_get_tissue_id):
#     """Rejects GCC when metadata doesn't match TPC."""
#     tpc_sample = make_tissue_sample(
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,
#         PRODUCTION_EXTERNAL_ID,
...
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_multiple_items_mixed(mock_fetch):
#     """Processes multiple TissueSamples correctly."""
#     # Mock returns appropriate samples for each external_id
#     def fetch_side_effect(external_id, cache, key):
#         if external_id == PRODUCTION_EXTERNAL_ID:
#             return []  # No existing for first
#         elif external_id == BENCHMARKING_EXTERNAL_ID:
#             return []  # No existing for second
#         return []
...
#     )
#     sample2 = make_tissue_sample(
#         "DAC_DIFFERENT_SAMPLE",  # Different submitted_id, same external_id
#         PRODUCTION_EXTERNAL_ID,
#         [GCC_TISSUE_SUBMITTED_ID],
#         submission_centers=[GCC_CENTER]
#     )
...
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_caching_behavior(mock_fetch):
#     """Verifies portal queries are cached."""
#     mock_fetch.return_value = []

#     # Two samples with same external_id
#     sample1 = make_tissue_sample(
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,
#         PRODUCTION_EXTERNAL_ID,
#         [NDRI_TISSUE_SUBMITTED_ID],
...
#     )
#     sample2 = make_tissue_sample(
#         NDRI_TISSUE_SAMPLE_SUBMITTED_ID,  # Same - an update
#         PRODUCTION_EXTERNAL_ID,
#         [NDRI_TISSUE_SUBMITTED_ID],
#         submission_centers=[NDRI_TPC_CENTER]
#     )
...
# @mock.patch('submitr.validators.tissue_sample_validator._get_or_fetch_tissue_samples')
# def test_metadata_validator_portal_query_failure(mock_fetch):
#     """Handles portal query failure gracefully."""
#     mock_fetch.return_value = None  # Portal query failed
...
# @mock.patch(
#     "submitr.validators.tissue_sample_validator.portal_utils.search_tissue_samples_by_external_id"
# )
# def test_get_tissue_samples_cache_hit(mock_search):
#     """Returns cached value without portal call."""
#     cache = {PRODUCTION_EXTERNAL_ID: [{"sample": "data"}]}
...
#     "submitr.validators.tissue_sample_validator.portal_utils.search_tissue_samples_by_external_id"
# )
# def test_get_tissue_samples_cache_miss_success(mock_search):
#     """Fetches from portal and caches result."""
#     cache = {}
#     sample_data = [{"external_id": PRODUCTION_EXTERNAL_ID}]
#     mock_search.return_value = sample_data
...
#     "submitr.validators.tissue_sample_validator.portal_utils.search_tissue_samples_by_external_id"
# )
# def test_get_tissue_samples_cache_miss_failure(mock_search):
#     """Returns None on portal failure."""
#     cache = {}
...
#     "submitr.validators.tissue_sample_validator.portal_utils.search_tissue_samples_by_external_id"
# )
# def test_get_tissue_samples_caches_result(mock_search):
#     """Verify result is added to cache."""
#     cache = {}
#     sample_data = [{"data": "test"}]
#     mock_search.return_value = sample_data
...
#     "submitr.validators.tissue_sample_validator.portal_utils.search_tissue_samples_by_external_id"
# )
# def test_get_tissue_samples_caches_none(mock_search):
#     """Verify None result is cached."""
#     cache = {}
#     mock_search.return_value = None
...
# )
# @mock.patch("submitr.validators.tissue_sample_validator.item_utils.get_submitted_id")
# def test_get_tissue_submitted_id_cache_hit(mock_get_submitted_id, mock_get_item):
#     """Returns cached submitted_id."""
#     cache = {TISSUE_UUID: NDRI_TISSUE_SUBMITTED_ID}
...
# @mock.patch("submitr.validators.tissue_sample_validator.item_utils.get_submitted_id")
# def test_get_tissue_submitted_id_cache_miss_success(
#     mock_get_submitted_id, mock_get_item
# ):
#     """Fetches from portal and caches."""
#     cache = {}
#     tissue_data = {"uuid": TISSUE_UUID, "submitted_id": NDRI_TISSUE_SUBMITTED_ID}
#     mock_get_item.return_value = tissue_data
#     mock_get_submitted_id.return_value = NDRI_TISSUE_SUBMITTED_ID

#     result = _get_tissue_submitted_id(TISSUE_UUID, cache, MOCK_PORTAL_KEY)

#     assert result == NDRI_TISSUE_SUBMITTED_ID
#     assert cache[TISSUE_UUID] == NDRI_TISSUE_SUBMITTED_ID
#     mock_get_item.assert_called_once_with(TISSUE_UUID, "Tissue", MOCK_PORTAL_KEY)


# @mock.patch(
#     "submitr.validators.tissue_sample_validator.portal_utils.get_item_by_identifier"
# )
# def test_get_tissue_submitted_id_not_found(mock_get_item):
#     """Returns None when tissue not found."""
#     cache = {}
...
# )
# @mock.patch("submitr.validators.tissue_sample_validator.item_utils.get_submitted_id")
# def test_get_tissue_submitted_id_caches_result(mock_get_submitted_id, mock_get_item):
#     """Verify submitted_id cached."""
#     cache = {}
#     tissue_data = {"uuid": TISSUE_UUID}
#     mock_get_item.return_value = tissue_data
...
#     "submitr.validators.tissue_sample_validator.portal_utils.get_item_by_identifier"
# )
# def test_get_tissue_submitted_id_caches_none(mock_get_item):
#     """Verify None result is cached."""
#     cache = {}
#     mock_get_item.return_value = None
...
# @mock.patch("submitr.validators.tissue_sample_validator.item_utils.get_submitted_id")
# def test_validate_metadata_consistency_all_match(
#     mock_get_submitted_id, mock_get_tissue_id
# ):
#     """No errors when all metadata matches."""
#     mock_data = make_structured_data_mock()
#     tissue_cache = {}
...
#     mock_get_submitted_id.return_value = NDRI_TISSUE_SAMPLE_SUBMITTED_ID
#     mock_get_tissue_id.side_effect = [GCC_TISSUE_SUBMITTED_ID, GCC_TISSUE_SUBMITTED_ID]
