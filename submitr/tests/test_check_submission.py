...
def test_check_submission_script():
    ...
    def test_it(args_in, expect_exit_code, expect_called, expect_call_args=None):
        ...
        with mock.patch.object(check_submission_module, "_monitor_ingestion_process") as mock_monitor_ingestion_process:
            ...
            assert mock_monitor_ingestion_process.call_count == (1 if expect_called else 0)
