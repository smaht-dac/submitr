...
from ..submission import (  # noqa
    ...
    _get_defaulted_consortia, _get_defaulted_submission_centers,
    ...
    GENERIC_SCHEMA_TYPE, DEFAULT_APP, _summarize_submission,
     _collapse_consecutive_ints, _collapse_formatted_srcs, _format_src,
    _format_issue,
)
...
def test_format_src_row_and_column():
    issue = {
        "src": {"file": "data.tsv", "column": "foo", "row": 3}
    }
    # row 3 becomes row 4
