...
#   The function here are called out to from RCloneTarget and RCloner. These use an
#   rclone config file which is auto-generated (to a temporary file) by RCloneTarget.
#
