...
# x = AmazonCredentials.obtain(ignore_environment_variables=False)
# x = AmazonCredentials.obtain("~/.aws_test.smaht-test")
# x = AmazonCredentials.obtain(ignore_environment_variables=False)
# x = AmazonCredentials.obtain(access_key_id="asdf",secret_access_key="asdfa")
# print(x)
# if x:
#     print(x.to_dictionary(environment_names=False))
