"""
This file has been copied to dcicutils.command_utils and will be available in dcicutils 0.40.0
"""
...
@mock.patch.object(utils_module, "PRINT")
@mock.patch.object(utils_module, "input")
