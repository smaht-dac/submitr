...
.. note::
    Note that this documentation mostly covers only the mechanics of using ``smaht-submitr``.
    It does not at this time cover the semantics of the actual content of metadata being submitted.
