...
.. raw:: html
    ...
    <table class="schema-table" width="104%"> <tr> <th> Property </td> <th> Type </td> <th> Description </td> </tr> <tr> <td width="5%" style="border-left:1px solid white;border-right:1px solid white;"> <b>tissue</b> </td> <td style="border-left:1px solid white;border-right:1px solid white;"> <a href=Tissue.html style='font-weight:bold;color:green;'><u>Tissue</u></a><br /><span style='color:green;'>string</span> </td> <td style="border-left:1px solid white;border-right:1px solid white;"> <i>See below for more details.</i> </td> </tr> </table>
