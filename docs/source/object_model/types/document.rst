...
..    View <a target="_blank" href="http://localhost:8000/search/?type=Document" style="color:black"><b><i><u>objects</u></i></b></a>
..    of this type: <a target="_blank" href="http://localhost:8000/search/?type=Document"><b>here</b><span class="fa fa-external-link" style="left:4pt;position:relative;top:2pt;" /></a>

.. raw:: html

    Summary of <a target="_blank" href="http://localhost:8000" style="color:black">SMaHT Portal</a> 
    <a target="_blank" href="http://localhost:8000/search/?type=Document&format=json" style="color:black">object</a> <a target="_blank" href="http://localhost:8000/profiles/Document.json?format=json" style="color:black">type</a>
    <a target="_blank" href="http://localhost:8000/profiles/Document.json" style="color:black"><b><u>Document</u></b></a><a target="_blank" href="http://localhost:8000/profiles/Document.json"><span class="fa fa-external-link" style="position:relative;top:1pt;left:4pt;color:black;" /></a> .
...
.. tip::
  ...
  .. raw::  html
    ...
    <i>See actual Document data <a target='_blank' href='http://localhost:8000/search/?type=Document'><b>here<span class='fa fa-external-link' style='left:6pt;position:relative;top:1pt;' /></b></a></i>
